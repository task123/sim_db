...
/// @brief Initialize SimDB with command line argument ```--id ID```, where ```ID```
//
/// is the id of the simulation parameters in the ```sim_db``` database.
...
/// @param name_column Name of the parameter and column in the database.
...
/// @param name_column Name of the column in the database to write to.
