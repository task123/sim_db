...
def command_line_arguments_parser(argv):
    ...
    parser.add_argument('--n_nodes', type=int, default=None, help="Number of nodes to run the simulation on.")
    parser.add_argument('--additional_lines', type=str, default=None, help="Additional lines added to the job script.")
