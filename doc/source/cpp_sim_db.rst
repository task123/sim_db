...
=========================
A parameter file called `params_mininal_cpp_example.txt` is located in the *sim_db/example/* directory in the `source code<https://github.com/jalsjf>`. The file contains the following:
